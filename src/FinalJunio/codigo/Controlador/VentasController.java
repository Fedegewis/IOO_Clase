...
public class VentasController {
    ...
    public float recaudacionPorPelicula(int peliculaID) {
        List<Funcion> funciones = funcionController.getInstance().buscarPeliculaPorFuncion(peliculaID);
    ...
    public VentaDto modelVentaToDto(Venta venta){
        return new VentaDto(String.valueOf(venta.getFuncionID()),modelFuncionToDto(venta.getFuncion()));
    }
