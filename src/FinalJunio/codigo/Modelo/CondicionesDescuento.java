package FinalJunio.codigo.Modelo;
...
public class CondicionesDescuento {
     ...
     * Default constructor
     */
    public CondicionesDescuento(Date fchDesde, Date fchHasta, int diaSemana, float porcentaje, TipoTarjeta tipoTarjeta, ArrayList<FinalJunio.codigo.Modelo.TarjetaDescuento> TarjetaDescuento ) {
